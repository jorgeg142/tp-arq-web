...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $sixMonthsAgo = $startMonth->copy()->subMonths(5);
        ...
        $months = collect(range(0,5))->map(fn($i) => $sixMonthsAgo->copy()->addMonths($i)->format('Y-m-01'));
        ...
        // Distribución por concepto (últimos 6 meses)
        ...
        $distLabels = $byConcept->pluck('concepto');
        ...
        return view('dashboard', [
            'kpis' => [
                ...
                'expiringMoM'   => $this->pctChange($expiringNext, $expiringPrev), // puede ser negativo
            ],
            'trend' => [
                'labels'       => $labels,
